...
{
    public class WebApiRaygunErrorMessage
    {
        public WebApiRaygunErrorMessage(Exception exception)
        {
            ...
            {
                InnerError = new WebApiRaygunErrorMessage(exception.InnerException);
            }
        }

        private WebApiRaygunErrorStackTraceLineMessage[] BuildStackTrace(Exception exception)
        {
            var lines = new List<WebApiRaygunErrorStackTraceLineMessage>();
            ...
            {
                var line = new WebApiRaygunErrorStackTraceLineMessage { FileName = "none", LineNumber = 0 };
                lines.Add(line);
            ...
            foreach (StackFrame frame in frames)
            {
                ...
                if (method != null)
                {
                    ...
                    var line = new WebApiRaygunErrorStackTraceLineMessage
                    {
                        FileName = file,
        ...
        public WebApiRaygunErrorMessage InnerError { get; set; }
        ...
        public WebApiRaygunErrorStackTraceLineMessage[] StackTrace { get; set; }
    }
}